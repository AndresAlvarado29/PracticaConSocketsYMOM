 ...
 */
public class ClienteVista2 extends javax.swing.JFrame implements Observer{
private Cliente c;
    /**
     ...
     */
    public ClienteVista2(String host, int port) throws IOException {
        initComponents();
    ...
    private void jEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jEnviarActionPerformed
       this.getRootPane().setDefaultButton(jEnviar);
       String mensaje ="Cliente 2: "+this.txtMensaje.getText()+"\n";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Socket sc = new Socket("192.168.18.60",6000);
        c= new Cliente(6000,mensaje);
        c.cerrarConexion(sc);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteVista2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteVista2().setVisible(true);
            }
        });
    }
